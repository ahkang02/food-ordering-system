...
# =============================================================================
# CREATE .HTACCESS FOR URL REWRITING (if not exists)
# =============================================================================
if [ ! -f "$DOCROOT/.htaccess" ]; then
    echo "Creating .htaccess for URL rewriting..."
    cat > "$DOCROOT/.htaccess" << 'HTACCESS_EOF'
RewriteEngine On
RewriteBase /
...
HTACCESS_EOF
    chown apache:apache "$DOCROOT/.htaccess" || chown www-data:www-data "$DOCROOT/.htaccess" || true
